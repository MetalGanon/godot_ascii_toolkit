...
static var after_splash_scene_name = (
	"res://MinimalWorkingGame/minimal_main_menu.tscn"
)
static var credits_scene_name = (
	"res://GodotASCIIToolKit/Credits/ascii_credits_screen.tscn"
)


func _init():
	## Setings project settings accordingly to ASCIISettings
	##
	## One day I would like to change the snap grid directly in this function
